...
public class Pantalla extends javax.swing.JFrame {
    ...
    private void disminuirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_disminuirActionPerformed
        ...
        int indi = Integer.parseInt(indice.getText());

        if (!indice.getText().equals("0")) {

            indi = indi - 1;
            indice.setText(String.valueOf(indi));
        } else {
            indice.setText("9");
            indi = 9;
        }
        dni.setText(String.valueOf(dnis[indi]));
        telefono.setText(String.valueOf(telefonos[indi]));
        nombre.setText(nombres[indi]);
        apellido.setText(apellidos[indi]);
        direccion.setText(direcciones[indi]);
        fechanac.setText(fechas[indi]);
    ...
    private void grabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_grabarActionPerformed
        ...
        int indi = Integer.parseInt(indice.getText());
        dnis[indi] = Long.parseLong(dni.getText());
        telefonos[indi] = Long.parseLong(telefono.getText());
        nombres[indi] = nombre.getText();
        apellidos[indi] = apellido.getText();
        direcciones[indi] = direccion.getText();
        fechas[indi] = fechanac.getText();
